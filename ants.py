"""The ants module implements game logic for this game."""
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        where_we_are = self.place.entrance
        counter = 1
        while where_we_are != hive:
            if counter >= self.min_range and counter <= self.max_range and where_we_are.bees:
                return random_or_none(where_we_are.bees)
            else:
                where_we_are = where_we_are.entrance
                counter += 1
        return None
...
class QueenAnt(ScubaThrower):  
    ...
    def __init__(self):
        ...
        self.armor = 1
        self.impostor_queen = QueenAnt.true_queen
    ...
    def action(self, colony):
        ...
        where_we_are = self.place.exit
        while where_we_are:
            if where_we_are.ant not in self.buffed_list and where_we_are.ant:
                where_we_are.ant.damage *= 2
                self.buffed_list.append(where_we_are.ant)
            if where_we_are.ant:
                if where_we_are.ant.container and where_we_are.ant.ant and where_we_are.ant.ant not in self.buffed_list:
                    where_we_are.ant.ant.damage *= 2
                    self.buffed_list.append(where_we_are.ant.ant)
            where_we_are = where_we_are.exit
